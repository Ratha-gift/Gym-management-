...
export default function EmptyState({ message, width = 100, height = 100, className = '' }: EmptyStateProps) {
  const { t } = useTranslation()
  return (
    <div className={`flex flex-col items-center justify-center gap-2 py-10 ${className}`}>
      <svg width={width} height={height} viewBox="0 0 184 152" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="No data illustration">
        <title>No data</title>
