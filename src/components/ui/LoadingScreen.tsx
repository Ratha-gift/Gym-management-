...
export default function LoadingScreen({ message }: { message?: string }) {
  ...
  return (
    <div className="flex min-h-screen animate-fade-in flex-col items-center justify-center gap-4 bg-[#f3f5f9] dark:bg-navy-900">
      ...
      <p className="text-sm font-medium text-gray-400 dark:text-gray-500">{message ?? t('common.loading')}</p>
    </div>
  )
}
